...
if not st.session_state.quiz_started:
    st.write("On this page, you need to take a quiz to check how well you understood the story you learned earlier!  \nFirst, listen to the audio, choose the correct words in order to fill in the blanks,  \nand then click the submit button!  \nIf you clicked the wrong answer, press the clear button.  \nIf you don’t know the answer, you can press the show answer button!")
